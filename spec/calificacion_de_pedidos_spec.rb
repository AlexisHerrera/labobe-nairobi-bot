...
describe 'Calificacion pedido' do
  ...
  it 'cuando envio </calificar npedido, calificacion> con un valor no numerico debería responder diciendo que la calificacion es invalida' do
    dado_que_quiero_calificar_una_calificacion_invalida(0)
    cuando_envio(token, '/calificar 1, Excelente')
    y_recibo_mensaje(token, 'Calificación inválida. Por favor califique con un valor de 1 a 5.')
